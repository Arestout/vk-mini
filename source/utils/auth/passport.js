  ...
  passport.use(
    new VKontakteStrategy(
      ...
      async (req, accessToken, refreshToken, profile, done) => {
        ...
        // https: //oauth.vk.com/authorize?client_id=6121396&scope=65539&redirect_uri=https://oauth.vk.com/blank.html&display=page&response_type=token&revoke=1
        https: req.session.accessToken = accessToken;
